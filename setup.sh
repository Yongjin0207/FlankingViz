...
setup_maize() {
    ...
    local B104_BASE="https://download.maizegdb.org/Zm-B104-REFERENCE-CORTEVA-1.0"
    local B73_BASE="https://download.maizegdb.org/Zm-B73-REFERENCE-NAM-5.0"

    download_if_missing \
        "${B104_BASE}/Zm-B104-REFERENCE-CORTEVA-1.0.fa.gz" \
    ...
    download_if_missing \
        "${B104_BASE}/Zm-B104-REFERENCE-CORTEVA-1.0_Zm00057aa.1.gff3.gz" \
    ...
    download_if_missing \
        "${B73_BASE}/Zm-B73-REFERENCE-NAM-5.0.fa.gz" \
        "${DIR}/Zm-B73-REFERENCE-NAM-5.0.fa.gz"
    test_gzip_or_fail "${DIR}/Zm-B73-REFERENCE-NAM-5.0.fa.gz"
    gunzip_to_if_missing \
        "${DIR}/Zm-B73-REFERENCE-NAM-5.0.fa.gz" \
        "${DIR}/Zm-B73-REFERENCE-NAM-5.0.fa"

    download_if_missing \
        "${B73_BASE}/Zm-B73-REFERENCE-NAM-5.0_Zm00001eb.1.gff3" \
        "${DIR}/Zm-B73-REFERENCE-NAM-5.0_Zm00001eb.1.gff3"
    ...
    write_note "${DIR}/download_sources.txt" \
        "b104_genome_url=${B104_BASE}/Zm-B104-REFERENCE-CORTEVA-1.0.fa.gz" \
        "b104_gff_url=${B104_BASE}/Zm-B104-REFERENCE-CORTEVA-1.0_Zm00057aa.1.gff3.gz" \
        "b104_blastdb_prefix=${DIR}/Zm-B104" \
        "b73_genome_url=${B73_BASE}/Zm-B73-REFERENCE-NAM-5.0.fa.gz" \
        "b73_gff_url=${B73_BASE}/Zm-B73-REFERENCE-NAM-5.0_Zm00001eb.1.gff3" \
        "b73_blastdb_prefix=${DIR}/Zm-B73" \
        "blastdb_mode=no_parse_seqids"
}
